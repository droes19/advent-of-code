...
public class day13_2 {
  public static void main(String[] args) {
    ...
    try (Scanner scan = new Scanner(new File("../input/day13.input"))) {
      ...
      people.put("You", new HashMap<>());
      for (String p1 : people.keySet()) {
        if (p1.equals("You")) {
          continue;
        }
        people.get(p1).put("You", 0);
        people.get("You").put(p1, 0);
      }

      String fixedPerson = "You";
      List<List<String>> arrangements = new ArrayList<>();
      generatePermutations(listPeople, 0, arrangements);
