  ...
  public static void main(String[] args) {
    ...
    try (Scanner scan = new Scanner(new File("../input/day15.input"))) {
      ...
      for (int teaspoon1 = 0; teaspoon1 <= 100; teaspoon1++) {
        ...
        int valueCalories1 = ingredients.get(keys.get(0)).get("calories") * teaspoon1;
        ...
        if (keys.size() == 2) {
          ...
          int valueCalories2 = ingredients.get(keys.get(1)).get("calories") * teaspoon2;
          ...
          int totalValueCalories = valueCalories1 + valueCalories2;
          totalValueCalories = Math.max(totalValueCalories, 0);
          int total =
              totalValueCapacity * totalValueDurability * totalValueFlavor * totalValueTexture;

          if (total > res && totalValueCalories == 500) {
            System.out.println("teaspoon1: " + teaspoon1 + ", teaspoon2: " + teaspoon2);
            res = total;
          }
        } else {
          for (int teaspoon2 = 0; teaspoon2 <= 100 - teaspoon1; teaspoon2++) {
            ...
            if (keys.size() == 3) {
              ...
              int valueCalories3 = ingredients.get(keys.get(2)).get("calories") * teaspoon3;
              ...
              totalValueTexture = Math.max(totalValueTexture, 0);
              int totalValueCalories = valueCalories1 + valueCalories2 + valueCalories3;
              totalValueCalories = Math.max(totalValueCalories, 0);
              int total =
                  totalValueCapacity * totalValueDurability * totalValueFlavor * totalValueTexture;
              if (total > res && totalValueCalories == 500) {
              ...
              for (int teaspoon3 = 0; teaspoon3 <= 100 - teaspoon1 - teaspoon2; teaspoon3++) {
                ...
                if (keys.size() == 4) {
                  ...
                  int valueCalories4 = ingredients.get(keys.get(3)).get("calories") * teaspoon4;
                  ...
                  totalValueTexture = Math.max(totalValueTexture, 0);
                  int totalValueCalories =
                      valueCalories1 + valueCalories2 + valueCalories3 + valueCalories4;
                  totalValueCalories = Math.max(totalValueCalories, 0);
                  int total =
                      totalValueCapacity
